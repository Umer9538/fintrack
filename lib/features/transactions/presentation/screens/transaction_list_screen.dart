                    ...
                    if (transaction.type == 'expense') {
                      ...
                      if (budget.amount > 0) {
                        ...
                        if (totalExpenses >= threshold &&
                          ...
                          _showNotification(
                            context,
                            'Warning: ${transaction.category} expenses are nearing your budget of \$${budget.amount.toStringAsFixed(2)}!',
                            Colors.orange,
                          );
                        } else if (totalExpenses >= budget.amount) {
                          _showNotification(
                            context,
                            'Alert: ${transaction.category} expenses have exceeded your budget of \$${budget.amount.toStringAsFixed(2)}!',
                            Colors.red,
                          );
                        }
                      }
