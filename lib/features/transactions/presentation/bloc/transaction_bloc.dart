...
import 'package:fintrack/features/transactions/presentation/bloc/transaction_event.dart';
import 'package:fintrack/features/transactions/presentation/bloc/transaction_state.dart';
  ...
  Future<void> _onAddTransaction(
    ...
    try {
      ...
      await _notificationService.sendNotification(
        ...
        body: 'You added a transaction of \$$amount for $description.',
