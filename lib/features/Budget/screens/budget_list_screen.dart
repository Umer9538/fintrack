          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text(
                    '\$${(budget.amount * progress).toStringAsFixed(2)} spent',
                    style: TextStyle(
                  ...
                  Text(
                    isExceeded
                        ? '\$${((budget.amount * progress) - budget.amount).toStringAsFixed(2)} over budget'
                        : '\$${(budget.amount - (budget.amount * progress)).toStringAsFixed(2)} remaining',
